...
<body class="app sidebar-mini">
  ...
  <header class="app-header">
    ...
    <!--Logo-->
    <a href="<?= base_url(); ?>">
						<!----><img src="<?=media() ?>/tienda/images/img/logo-svg1.svg" class="app-header__logo" alt="Oh my pet-Petshop">
		</a><!-- Logo antiguo <a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Oh my pet !</a>-->
