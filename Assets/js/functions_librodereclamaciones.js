let tableReclamos;
tableReclamos = $('#tableReclamos').dataTable({
    "aProcessing": true,
    "aServerSide": true,
    "language": {
    ...
    "ajax": {
        "url": " " + base_url + "/LibroReclamacionesGestion/getLibroReclamacionesGestion",
        "dataSrc": ""
    },
    "columns": [
        { "data": "id" },
...
function fntViewInfo(idmensaje) {
    ...
    let ajaxUrl = base_url + '/LibroReclamacionesGestion/getMensajeReclamos/' + idmensaje;
    ...
    request.onreadystatechange = function() {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                document.querySelector("#celAsunto").innerHTML = objMesaje.asunto;
